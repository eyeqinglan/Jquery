...
(function ($) {
  ...
  var barcode = {
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      if (settings.showHRI){
        content += "<div style=\"clear:both; width: 100%; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: center; font-size: " + settings.fontSize + "px; font: 微软雅黑;padding-top: " + settings.paddingHRI + "px; margin-top: " + settings.marginHRI + "px;\">"+hri+"</div>";
      }
  ...
  $.fn.extend({
    barcode: function(datas, type, settings) {
      ...
      if (typeof(settings.hriText) == "string" && settings.hriText != '') {
      	hri = settings.hriText;
      }
